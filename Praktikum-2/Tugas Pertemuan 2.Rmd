...
summary(model)
```
$$y_i = -209200+100x1_t+0.6036x2_t-28270x3_t$$
...
Nilai DW setelah dilakukan penanganan meningkat menjadi $DW = 1.85127$. Nilai DW sudah berada pada rentang DU \< DW \< 4-DU atau $1.6692 < DW < 2.3308$, maka sudah tidak ada autokorelasi positif. Hal tersebut juga didukung oleh *p-value* sebesar $0.2534$, di mana *p-value* \> $\alpha$=5%. Artinya tak tolak $H_0$ atau belum cukup bukti menyatakan bahwa ada autokorelasi pada taraf nyata 5%.
